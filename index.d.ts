...
import { RequestHandler as FastifyRequestHandler, FastifyRequest } from "fastify";
...
export function i18nPlugin(options: i18nOptions, callback: Callback): FastifyRequestHandler;
